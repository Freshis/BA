...
\begin{minipage}{0.45\textwidth}
	\includegraphics[width=1.1\textwidth]{figures/1_dim_gauss.png}
	\caption*{(i)Gauß-Funktion}
\end{minipage}
\begin{minipage}{0.45\textwidth}
	\includegraphics[width=1.1\textwidth]{figures/1_dim_multi.png}
...
\begin{figure}[ht]
	\centering
\begin{minipage}{0.45\textwidth}
	\includegraphics[width=1.1\textwidth]{figures/2_dim_gauss.png}
	\caption*{(i)Gauß-Funktion}
\end{minipage}
\begin{minipage}{0.45\textwidth}
	\includegraphics[width=1.1\textwidth]{figures/2_dim_multi.png}
	\caption*{(ii)Multiquadratische-Funktion}
\end{minipage}
