...
\hspace{1.4cm}
\begin{minipage}{0.4\textwidth}
\includegraphics[width=1.2\textwidth]{figures/T_pi/numerical_solution_stab_high_n_100.png}
\end{minipage}
...
\hspace{0.1cm}
\begin{minipage}{0.4\textwidth}
\includegraphics[width=1.2\textwidth]{figures/n_80_pi_variable/T_pi_2/numerical_solution_stab_high.png}
\end{minipage}
\hspace{1.4cm}
\begin{minipage}{0.4\textwidth}
...
\begin{figure}[H]
\begin{minipage}{0.4\textwidth}
\includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/1_Pi/initial_solution.png}
\end{minipage}
\hspace{1.4cm}
\begin{minipage}{0.4\textwidth}
\includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/1_Pi/initial_solution_top.png}
\end{minipage}
...
\begin{figure}[H]
\begin{minipage}{0.45\textwidth}
 \includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/Pi_2/numerical_solution_stab_high_top.png}
\vspace{-0.4cm}
\end{minipage}
\begin{minipage}{0.45\textwidth}
 \includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/1_Pi/numerical_solution_stab_high_top.png}
\vspace{-0.4cm}
\end{minipage}
...
\begin{figure}[H]
\begin{minipage}{0.45\textwidth}
 \includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/3_Pi_2/numerical_solution_stab_high_top.png}
\vspace{-0.4cm}
\end{minipage}
\begin{minipage}{0.45\textwidth}
 \includegraphics[width=1.2\textwidth]{figures/Gesicht/n_100/2_Pi/numerical_solution_stab_high_top.png}
\vspace{-0.4cm}
\end{minipage}
